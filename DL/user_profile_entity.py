class BaseUserProfileEntity:
    def __init__(self, user_id: str, user_name: str, expense_types: list, payment_methods: list, monthly_income: float):
...
class UserProfileEntity(BaseUserProfileEntity):
    def __init__(self, user_id: str, user_name: str, expense_types: list, payment_methods: list, monthly_income: float, id: str = None):
        super().__init__(user_id, user_name, expense_types, payment_methods, monthly_income)
        self.id = id
